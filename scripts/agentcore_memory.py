...
def cli(ctx):
    ...
    Create and delete AgentCore memory resources for the intelligent healthcare application.
    """
...
@cli.command()
@click.option(
    "--name", default="ChatMemory", help="Name of the memory resource"
)
@click.option(
    "--ssm-param",
    default="/app/medicalassistant/agentcore/memory_id",
...
def create(name, ssm_param, event_expiry_days):
    ...
    strategies = [
        {
            StrategyType.SEMANTIC.value: {
                ...
                "namespaces": ["medicalassistant/user/{actorId}/facts"],
            },
        },
        {
            StrategyType.SUMMARY.value: {
                ...
                "namespaces": ["medicalassistant/user/{actorId}/{sessionId}"],
            },
        },
        {
            StrategyType.USER_PREFERENCE.value: {
                ...
                "namespaces": ["medicalassistant/user/{actorId}/preferences"],
            },
        },
    ]
    ...
    try:
        ...
        memory = memory_client.create_memory_and_wait(
            ...
            description="Memory for healthcare support agent",
